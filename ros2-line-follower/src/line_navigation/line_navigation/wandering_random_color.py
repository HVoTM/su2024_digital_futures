...
class LineFollower(Node):
    ...
    def timer_callback(self):
        """
        Function to be called when timer ticks, basically will check time as well as 
        ...
        if self.should_move:
            ...
            # TODO: Publish the message to `/cmd_vel`
